<template>
    <div v-if="getTask.length>0" class="">
        <div class="grid grid-cols-1 grid-cols-4 gap-4">
            <div v-for="(item, index) in getTask" :key="index" class="border rounded-lg overflow-hidden shadow-md">
                <div class="p-4">
                    ...
                    <div class="grid grid-cols-8">
                        ...
                        <CustomButton class="col-span-3" @click="addCart(item.itemId, index)" buttonName="Add to cart">
                        </CustomButton>
                    </div>
        ...
        <router-link to="/cart">
            <CustomButton  buttonName="View Your Cart"/>
        </router-link>
    </div>
     <div v-else class="flex flex-col items-center justify-center text-center">
              ...
              <p class="font-semibold mt-2">No Products To View :( </p>
            </div>
</template>
